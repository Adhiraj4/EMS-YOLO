...
Usage:
    $ python path/to/train.py --data coco128.yaml --weights ***.pt --img 640
"""
import argparse
import math
import os
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    train_loader, dataset = create_dataloader(train_path, opt.sample_size,opt.T,opt.image_shape, 'train', batch_size // WORLD_SIZE, gs, single_cls,
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/resnet34-cat.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/gen1.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--device', default='0,1,2,3,4,5,6,7', help='cuda device, i.e. 0 or 0,1,2,3,4,5,6,7 or cpu')
